...
- [style.md](style.md) : frontend : **les trois systèmes d'icônes** (Font Awesome, Remixicon, SVG bootstrap-icons collés à la main), variables de couleurs `--bb-*`, entries AssetMapper.
